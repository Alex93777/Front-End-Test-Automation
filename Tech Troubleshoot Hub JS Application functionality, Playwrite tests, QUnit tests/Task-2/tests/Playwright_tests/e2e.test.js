...
describe("e2e tests", () => {
    ...
    describe("CRUD", () => {
        ...
        test('Create makes correct API call', async()=>{
            ...
            //act
            await page.fill("#name", "Random test title");
            await page.fill("#imgUrl", "/images/To-kill-a-mockingbird.jpg");
            await page.fill("#price", "20.59");
            await page.fill("#releaseDate", "29.06.2024");
            await page.fill("#artist", "Alex");
            await page.fill("#genre", "test");
